...
#     'stem': [0],
#     'stem_size': 1,
#     'norm_cell': ['pre_proc1', 'pre_proc2', 'sep_conv1', 'sep_conv2', 'sep_conv3', 'sep_conv4', 'sep_conv5',
#                   'dil_conv'],
#     'norm_cell_size': 24,
#     'red_cell': ['red_conv'],
#     'red_cell_size': 2,
#     'norm_red_cell': ['red_conv', 'pre_proc', 'sep_conv1', 'sep_conv2', 'sep_conv3', 'sep_conv4', 'sep_conv5',
#                       'dil_conv'],
#     'norm_red_cell_size': 25
# }
# norm_cell_mapping = {
#     'pre_proc1': [0],
#     'pre_proc2': [1],
#     'sep_conv1': [2, 3, 4, 5],
#     'sep_conv3': [10, 11, 12, 13],
#     'sep_conv2': [6, 7, 8, 9],
#     'sep_conv4': [14, 15, 16, 17],
#     'sep_conv5': [18, 19, 20, 21],
#     'dil_conv': [22, 23]
# }
# red_cell_mapping = {
#     'red_conv': [0, 1]  # seperate them
# }
# norm_red_cell_mapping = {
#     'red_conv': [0, 1],
#     'pre_proc': [2],
#     'sep_conv1': [3, 4, 5, 6],
#     'sep_conv3': [11, 12, 13, 14],
#     'sep_conv2': [7, 8, 9, 10],
#     'sep_conv4': [15, 16, 17, 18],
#     'sep_conv5': [19, 20, 21, 22],
#     'dil_conv': [23, 24]
# }
...
if __name__ == '__main__':
    cell_list = [[48], [16, 18, 20, 22], [24, 26, 28, 30], [32], [34, 36, 38, 40], [42], [44, 46, 48, 50], [52, 54, 56, 58]]
    sep_conv_list = [[16, 20, 22, 24, 26], [26, 28, 30, 32, 34], [40, 40, 40, 40, 40], [46, 46, 50, 46, 46],
                     [56, 56, 56, 56, 56]]
    ...
    cell_list,sep_conv_list,cell_list_prev_ops,cell_list_factor,sep_conv_list_prev_ops,sep_conv_list_factor = channel_size_adjust_algorithm(cell_list, sep_conv_list, delta_threshold, min_scale_limit, map_cond_threshold, min_conv_size, max_conv_size,
